...
public class ProdutoController {
	...
	public Produto put(@RequestBody Produto novaProduto) {
		return this.repo.findById(novaProduto.getProdutoID()).map(cat -> {
	...
	//busca produto pela subcategoria por ID
	@GetMapping(path = "/subcategorias/{catid}/produtos")
	public List<Produto> getProdutoPorID(@PathVariable int catid) {
		return this.repo.findBySubCategoriaID(catid);
	}
